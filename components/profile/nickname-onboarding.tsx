  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-5">
      <motion.form
        ...
        className="w-full max-w-sm rounded-3xl border-3 border-black bg-brand-yellow p-6 shadow-neo-lg"
      ...
      >
        ...
        <input
          autoFocus
          className="mt-5 w-full rounded-xl border-3 border-black bg-white px-4 py-3 font-black shadow-neo"
          maxLength={10}
